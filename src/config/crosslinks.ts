...
export const CROSSLINKS: CrossLink[] = [
  ...
  // ── Урок 1.3: Q-Learning ──
  { lessonId: "1-3", lessonPath: "/courses/1-3", lessonTitle: "Q-Learning: табличный метод", lessonLevel: 1, hubPath: "/deep-rl", hubAnchor: "algorithms", hubLabel: "Deep RL → Алгоритмы", contextInLesson: "Переход от табличного метода к deep-подходам", contextInHub: "Q-Learning как предшественник DQN (Урок 1.3)" },
  { lessonId: "1-3", lessonPath: "/courses/1-3", lessonTitle: "Q-Learning: табличный метод", lessonLevel: 1, hubPath: "/math-rl/module-5", hubAnchor: "глава-6", hubLabel: "Математика → Глава 6. Model-Free RL", contextInLesson: "Обновление Q-таблицы и сходимость", contextInHub: "Формулы Q-Learning (Урок 1.3)" },
  { lessonId: "1-3", lessonPath: "/courses/1-3", lessonTitle: "Q-Learning: табличный метод", lessonLevel: 1, hubPath: "/math-rl/module-5", hubAnchor: "глава-5", hubLabel: "Математика → Глава 5. Уравнения Беллмана", contextInLesson: "Беллман-оптимальность как основа update-шага", contextInHub: "Беллман в Q-Learning (Урок 1.3)" },
  ...
  { lessonId: "1-6", lessonPath: "/courses/1-6", lessonTitle: "Марковские процессы принятия решений (MDP)", lessonLevel: 1, hubPath: "/math-rl/module-5", hubAnchor: "глава-5", hubLabel: "Математика → Глава 5. Уравнения Беллмана", contextInLesson: "Рекурсивная структура функции ценности", contextInHub: "Интуитивный разбор Беллмана (Урок 1.6)" },
  { lessonId: "1-6", lessonPath: "/courses/1-6", lessonTitle: "Марковские процессы принятия решений (MDP)", lessonLevel: 1, hubPath: "/math-rl/module-5", hubAnchor: "глава-3", hubLabel: "Математика → Глава 3. MDP", contextInLesson: "Формальное описание MDP-среды", contextInHub: "MDP на практике (Урок 1.6)" },
  { lessonId: "1-6", lessonPath: "/courses/1-6", lessonTitle: "Марковские процессы принятия решений (MDP)", lessonLevel: 1, hubPath: "/math-rl/module-5", hubAnchor: "глава-6", hubLabel: "Математика → Глава 6. Model-Free RL", contextInLesson: "Переход от DP к Model-Free методам", contextInHub: "Связка с Model-Free (Урок 1.6)" },
