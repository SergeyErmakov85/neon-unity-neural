...
const levels = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { title: "Обучение в Unity ML-Agents", type: "lesson", path: "/courses/2-4" },
      { title: "Curriculum Learning", type: "lesson", path: "/courses/2-5" },
      { title: "A3C и асинхронное обучение", type: "lesson", path: "/courses/2-6" },
