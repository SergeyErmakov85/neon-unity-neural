...
const levels = [
  ...
  },
  {
    ...
    lessons: [
      ...
      { title: "Оптимизация гиперпараметров", type: "lesson", path: "/courses/3-5" },
      { title: "Деплой моделей в продакшн", type: "lesson", path: "/courses/3-6" },
      { title: "Transfer Learning в RL", type: "lesson", path: "/courses/3-7" },
      { title: "Финальный проект: Soccer Agents", type: "project", path: "/courses/project-4" },
    ],
  },
];
