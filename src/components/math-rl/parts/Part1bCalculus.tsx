...
const Part1bCalculus = () => (
  <>
    ...
    <Section icon={<BookOpen className="w-5 h-5 text-primary" />} title="§ 1. Производные и дифференцирование">
      <h3 className="text-xl font-semibold text-foreground mt-4 mb-3" id="определение-производной">Определение производной</h3>
      <DefinitionBox>
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="три-интуиции">Три интуиции</h3>
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="таблица-основных-производных">Таблица основных производных</h3>
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="правила-дифференцирования">Правила дифференцирования</h3>
      ...
      <h3 className="text-xl font-semibold text-foreground mt-10 mb-3" id="-практические-задачи">✏️ Практические задачи</h3>
...
print(f'dL/dw (числен.) = {dL_dw_numeric:.6f}')`}
    ...
    <Section icon={<TrendingUp className="w-5 h-5 text-secondary" />} title="§ 2. Частные производные и градиент">
      <h3 className="text-xl font-semibold text-foreground mt-4 mb-3" id="функции-многих-переменных">Функции многих переменных</h3>
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="частная-производная">Частная производная</h3>
      <DefinitionBox>
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="градиент">Градиент</h3>
      <DefinitionBox>
...
try:
    ...
    <Section icon={<Layers className="w-5 h-5 text-accent" />} title="§ 3. Градиентный спуск и оптимизация">
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="варианты-градиентного-спуска">Варианты градиентного спуска</h3>
      <div className="my-4 overflow-x-auto">
        <table className="w-full text-sm border border-border/30 rounded-lg overflow-hidden">
          <thead>
            <tr className="bg-card/60">
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="проблемы-и-решения">Проблемы и решения</h3>
      <div className="my-4 overflow-x-auto">
        <table className="w-full text-sm border border-border/30 rounded-lg overflow-hidden">
          <thead>
            <tr className="bg-card/60">
...
for alpha in [0.01, 0.1, 0.5, 1.05]:
    ...
    <Section icon={<BarChart3 className="w-5 h-5 text-primary" />} title="§ 4. Применение в RL: Policy Gradient">
      <h3 className="text-xl font-semibold text-foreground mt-4 mb-3" id="задача-оптимизации-политики">Задача оптимизации политики</h3>
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="теорема-о-градиенте-политики">Теорема о градиенте политики</h3>
      ...
      <h3 className="text-xl font-semibold text-foreground mt-8 mb-3" id="tdошибка-как-стохастический-градиент">TD-ошибка как стохастический градиент</h3>
...
print(f'V истинное:  {np.round(V_true, 4)}')`}
    ...
    <Section icon={<Lightbulb className="w-5 h-5 text-primary" />} title="§ 5. Весь раздел в одной картине">
      ...
      <div className="my-8 p-6 rounded-xl border-2 border-green-500/30 bg-green-500/5">
        <h3 className="text-lg font-bold text-foreground mb-4" id="-что-вы-изучили-в-этом-разделе">✅ Что вы изучили в этом разделе</h3>
