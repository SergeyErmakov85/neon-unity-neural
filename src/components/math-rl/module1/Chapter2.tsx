...
const Chapter2 = () => (
  <Section icon={<Target className="w-5 h-5 text-accent" />} title="Глава 2. Многорукие бандиты: Исследование vs Использование">
    ...
    <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Дилемма Exploration vs Exploitation</h3>
    ...
    <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Ценность действия (Action-Value)</h3>
    <p>
    ...
    <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">ε-жадная стратегия</h3>
    <p>
    ...
    <h3 className="text-xl font-semibold text-foreground mt-8 mb-3">Верхняя доверительная граница (UCB)</h3>
    <p>
