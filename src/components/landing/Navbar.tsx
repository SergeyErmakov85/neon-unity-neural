  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-background/90 backdrop-blur-md border-b border-primary/30 shadow-glow-cyan"
          : "bg-transparent"
      }`}
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <Button
              size="sm"
              className="bg-gradient-neon hover:shadow-glow-cyan hover:scale-105 transition-all duration-300"
            >
              Начать обучение
            </Button>
          </div>
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            <SheetTrigger asChild className="lg:hidden">
              <Button
                variant="ghost"
                size="icon"
                className="text-primary hover:bg-primary/10 hover:shadow-glow-cyan"
              >
            ...
            <SheetContent
              side="right"
              className="w-80 bg-background/95 backdrop-blur-xl border-l border-primary/30"
            >
              <div className="flex flex-col h-full pt-8">
                ...
                <div className="mt-auto flex flex-col gap-3 px-2 pb-8">
                  ...
                  <Button
                    variant="outline"
                    className="w-full border-primary/50 text-primary hover:bg-primary/10 hover:border-primary"
                    onClick={() => { setIsOpen(false); navigate("/unity-ml-agents"); }}
                  >
                    <Gamepad2 className="w-4 h-4 mr-1" />
                    UnityML-Agents
                  </Button>
                  ...
                  <Button className="w-full bg-gradient-neon hover:shadow-glow-cyan">
                    Начать обучение
                  </Button>
                </div>
              </div>
