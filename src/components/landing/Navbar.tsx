      ...
      <div className="container px-4 mx-auto">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          window.scrollTo({
            ...
            <img src={logoImage} alt="RL Platform" className="h-32 md:h-40 w-auto mt-12 transition-all duration-300 group-hover:drop-shadow-[0_0_15px_hsl(var(--primary)/0.5)]" />
          </a>
